...
def main():
    ...
    print("  Created: missing_picons.txt with " +
          str(len(missing_list)) + " entries")
    ...
    print("Known: " + str(known) +
          " (" + str(round(known / len(png_data) * 100, 1)) + "%)")
    print("Unknown: " + str(unknown) +
          " (" + str(round(unknown / len(png_data) * 100, 1)) + "%)")
